...
files<-paste0("Results2/",list.files("Results2/"))
type<-factor()
trueStrengths<-list(BradleyTerryGamma=vector("list", 1),Beta=vector("list", 1), ThurstoneMostellerNormal=vector("list", 1), ExtremeBT=vector("list",1))
centeringValues<-list(BradleyTerryGamma=vector("list", 1),Beta=vector("list", 1), ThurstoneMostellerNormal=vector("list", 1), ExtremeBT=vector("list",1))
strengths<-list(BradleyTerryGamma=vector("list", 1),Beta=vector("list", 1), ThurstoneMostellerNormal=vector("list", 1), ExtremeBT=vector("list",1))
correlations<-list(BradleyTerryGamma=vector("list", 1),Beta=vector("list", 1), ThurstoneMostellerNormal=vector("list", 1), ExtremeBT=vector("list",1))
gameBias<-list(BradleyTerryGamma=vector("list", 1),Beta=vector("list", 1), ThurstoneMostellerNormal=vector("list", 1), ExtremeBT=vector("list",1))
weeklyGameBias<-list(BradleyTerryGamma=vector("list", 1),Beta=vector("list", 1), ThurstoneMostellerNormal=vector("list", 1), ExtremeBT=vector("list",1))
